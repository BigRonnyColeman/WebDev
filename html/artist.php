...
<head>
    ...
    <meta name="description" content="Art Dealer Artist Page">
    <style>
        header {
    ...
    <div class="section">
        <div class="row">
            <div class="column">
                <div class=artistGroup>
                    <script language="javascript">
                        document.write('<a href="artpiece.php?artist=' + artistvalue + '&artnumber=1">')
                    </script>
                    <script language="javascript">
            ...
            <div class="column">
                <div class=artistGroup>
                    <script language="javascript">
                        document.write('<a href="artpiece.php?artist=' + artistvalue + '&artnumber=2">')
                    </script>
                    <script language="javascript">
            ...
            <div class="column">
                <div class=artistGroup>
                    <script language="javascript">
                        document.write('<a href="artpiece.php?artist=' + artistvalue + '&artnumber=3">')
                    </script>
                    <script language="javascript">
            ...
            <div class="column">
                <div class=artistGroup>
                    <script language="javascript">
                        document.write('<a href="artpiece.php?artist=' + artistvalue + '&artnumber=4">')
                    </script>
                    <script language="javascript">
